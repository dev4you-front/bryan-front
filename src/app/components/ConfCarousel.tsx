  ...
  return (
    <div className="relative w-full my-12">
      ...
      <button
        ...
        className="swiper-button-prev custom-swiper-arrow absolute left-0 md:-left-12 top-1/3 -translate-y-1/2 z-20"
        onClick={goPrev}
      />
      ...
      <button
        aria-label="Suivant"
        className="swiper-button-next custom-swiper-arrow absolute right-0 md:-right-12 top-1/3 -translate-y-1/2 z-20"
        onClick={goNext}
      />
    </div>
  );
