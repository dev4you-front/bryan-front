        ...
        <div className="grid gap-4 sm:gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            ...
            <article key={idx} className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden flex flex-col transform transition duration-300 hover:scale-[1.02] hover:shadow-xl hover:border-brandviolet/20 w-full">
              ...
              <div className="p-4 sm:p-5 flex-1 flex flex-col">
                ...
                <a href={a.link} className="inline-flex items-center justify-center mt-auto bg-brandviolet text-white font-semibold py-2.5 px-4 rounded-lg hover:bg-purple-600 transition-colors duration-200 text-sm w-full">
                  Lire l'article
